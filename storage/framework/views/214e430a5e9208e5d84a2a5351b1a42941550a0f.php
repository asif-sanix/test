    ...
    <div id="content-wrapper">  
        ...
        <div class="home-slider-wrapper clearfix">
            <div class="camera_wrap" id="home-slider">
                <?php $__currentLoopData = App\Slider::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div data-src="<?php echo e($sl->url); ?>">
                                            ...
                                            <div id="home_products">
                                                ...
                                                <div class="element no_full_width col-md-8 col-sm-8 not-animated" data-animate="fadeInUp" data-delay="1">
                                                    <ul class="row-container list-unstyled clearfix">
                                                        ...
                                                        <img src="<?php echo e($p->image); ?>" class="img-responsive" alt="Curabitur cursus dignis" style="max-height: 100">
                                                        </a>
                                                        <div class="hbw">
                                    ...
                                    <div id="home_blog" class="home-blog">
                                        ...
                                        <div class="home-blog-item row">
                                            ...
                                            <div class="home-blog-content col-md-20">
                                                <h4><a href="#"><?php echo e($n->title); ?></a></h4>
                                            ...
                                            <div id="home_fp">                                                                                         
                                                ...
                                                <div class="element no_full_width not-animated" data-animate="fadeInUp" data-delay="200">
                                                    <ul class="row-container list-unstyled clearfix">
                                                        <li class="row-left">
                                                        <a href="<?php echo e(route('product.detail',$p->slug)); ?>" class="container_item">
                                                        <img src="<?php echo e($p->image); ?>" class="img-responsive" alt="Curabitur cursus dignis" style="min-height: 100px;">
                                                        </a>
                                                        <div class="hbw">
                                                            <span class="hoverBorderWrapper"></span>
                                                        </div>
                                    ...
                                    <div id="partners-container" class="clearfix">
                                        ...
                                        <div id="partners">
                                            <?php
                                                $delay = '150';
                                            ?>
                                            <?php $__empty_1 = true; $__currentLoopData = App\PopulerBrand::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $br): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="logo text-center not-animated" data-animate="bounceIn" data-delay="<?php echo e($delay); ?>">
                                                <a class="animated" href="collection.html">
                                                <img class="pulse" src="<?php echo e($br->url); ?>" alt="">
                                                </a>
                                            </div>
                                            <?php
                                                $delay += 150;
