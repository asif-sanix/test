        ...
        <div class="container">
          <div class="top row">
            <div class="col-md-6 phone-shopping">
              <span>PHONE SHOPING: +91 9934-442-007</span>
            </div>
            <div class="col-md-18">
              <ul class="text-right">
                ...
                <ul class="list-inline">
                    <li class="top-logo">
                        <a id="site-title" href="<?php echo e(route('welcome')); ?>" >          
                            <img class="img-responsive" src="<?php echo e(url('image/logo.png')); ?>" style="height: 50px; ">
                            <label style="font-size: 18px; position: relative; top: -36px; left: 100px;">Alankarjewellery</label>          
                        </a>
                    </li>
                    <li class="navigation">         
                        <nav class="navbar">
                            <div class="clearfix">
                                ...
                                <div class="collapse navbar-collapse">
                                    <ul class="nav navbar-nav hoverMenuWrapper">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = TCG\Voyager\Models\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <li class="nav-item">
