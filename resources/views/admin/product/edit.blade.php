      ...
      <div class="card">
        <div class="body">
             ...
             <div class="form-group {{ $errors->has('body') ? ' has-error' : '' }}">
                 ...
                 {!! Form::textarea('body', $category->body, ['class' => 'summernote form-control', 'placeholder' => 'Description']) !!}
         ...
         <div class="card">
           <div class="body">
             ...
             <div class="form-group{{ $errors->has('meta_title') ? ' has-error' : '' }}">
                 ...
                 {!! Form::text('meta_title', $category->meta_title, ['class' => 'form-control', 'placeholder' => 'Meta Title']) !!}
                 <small class="text-danger">{{ $errors->first('meta_title') }}</small>
             </div>

             <div class="form-group{{ $errors->has('meta_description') ? ' has-error' : '' }}">
                 {!! Form::label('meta_description', 'Meta Description') !!}
                 {!! Form::textarea('meta_description', $category->meta_description, ['class' => 'form-control', 'placeholder' => 'Meta Description']) !!}
        ...
        <div class="body">
          <div class="form-group">
              <div class="checkbox fancy-checkbox {{ $errors->has('status') ? ' has-error' : '' }}">
                  <label for="status">
                      {!! Form::checkbox('status', '1', $category->status, ['id' => 'status']) !!} <span> <b>Status</b> </span>
                  </label>
              </div>
      ...
      <div class="card">
        <div class="body">
           <div class="form-group {{ $errors->has('file') ? ' has-error' : '' }}">
               {!! Form::file('file', ['class'=>'dropify','data-default-file'=>$category->file?Storage::disk('local')->url($category->file):'']) !!}
               {!! Form::hidden('checkfile',$category->file?Storage::disk('local')->url($category->file):'', ['id' => 'checkfile']) !!}
