                            ...
                            <ul class="right_chat list-unstyled">
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{asset('admin-assets/assets/images/xs/avatar4.jpg')}}" alt="">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{asset('admin-assets/assets/images/xs/avatar5.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{asset('admin-assets/assets/images/xs/avatar2.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{asset('admin-assets/assets/images/xs/avatar1.jpg')}}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{asset('admin-assets/assets/images/xs/avatar3.jpg')}}" alt="">
                                            <div class="media-body">
                            ...
                            <ul class="list-unstyled contact-list">
                                <li class="d-flex align-items-center">
                                    <span class="contact-img">
                                        <img src="{{asset('admin-assets/assets/images/xs/avatar1.jpg')}}" class="rounded" alt="">
                                    </span>
                                    <h4 class="contact-name">Vincent Porter <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                    <span class="contact-img">
                                        <img src="{{asset('admin-assets/assets/images/xs/avatar2.jpg')}}" class="rounded" alt="">
                                    </span>
                                    <h4 class="contact-name">Mike Thomas <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                    <span class="contact-img">
                                        <img src="{{asset('admin-assets/assets/images/xs/avatar3.jpg')}}" class="rounded" alt="">
                                    </span>
                                    <h4 class="contact-name">Aiden Chavaz</h4>
                                </li>
                                <li class="d-flex align-items-center">
                                    <span class="contact-img">
                                        <img src="{{asset('admin-assets/assets/images/xs/avatar4.jpg')}}" class="rounded" alt="">
                                    </span>
                                    <h4 class="contact-name">Vincent Porter <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                    <span class="contact-img">
                                        <img src="{{asset('admin-assets/assets/images/xs/avatar5.jpg')}}" class="rounded" alt="">
                                    </span>
                                    <h4 class="contact-name">Mike Thomas <span class="d-block">London UK</span></h4>
                                </li>
                                <li class="d-flex align-items-center">
                                    <span class="contact-img">
                                        <img src="{{asset('admin-assets/assets/images/xs/avatar6.jpg')}}" class="rounded" alt="">
                                    </span>
                                    <h4 class="contact-name">Aiden Chavaz</h4>
                                </li>                             
                            </ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="desc">
                                            ...
                                            <ul class="list-unstyled team-info margin-0 p-t-5">                                            
                                                <li><img src="{{asset('admin-assets/assets/images/xs/avatar1.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{asset('admin-assets/assets/images/xs/avatar2.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{asset('admin-assets/assets/images/xs/avatar3.jpg')}}" alt="Avatar"></li>
                                                <li><img src="{{asset('admin-assets/assets/images/xs/avatar4.jpg')}}" alt="Avatar"></li>                                            
                                            </ul>
                                        </div>
                                    </li>
                                    <li>
