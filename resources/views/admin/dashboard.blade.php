...
@push('links')
<link rel="stylesheet" href="{{asset('admin-assets/assets/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')}}">
<link rel="stylesheet" href="{{asset('admin-assets/assets/vendor/chartist/css/chartist.min.css')}}">
<link rel="stylesheet" href="{{asset('admin-assets/assets/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css')}}">
@endpush
@section('main')
...
<script src="{{asset('admin-assets/assets/vendor/flot-charts/jquery.flot.selection.js')}}"></script>
